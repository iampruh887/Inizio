...
document.addEventListener("DOMContentLoaded", () => {
   ...
   const slideData = [
      { name: "digital-duel", text: "digital duel is a fast-paced marketing competition where participants craft impactful strategies.\n\nwhether you’re a branding enthusiast, content creator, or strategist, this event challenges you to think fast and sell like a pro.\n\ngiven a product, brand, or scenario, teams must develop creative campaigns within a time limit. challenges may include social media strategies, ad campaigns, or crisis management. pitches will be judged on creativity, feasibility, and impact.\n\nwhether you're into digital ads, influencer marketing, or branding, digital duel pushes you to think outside the box and compete for the title of the ultimate marketing strategist." },
